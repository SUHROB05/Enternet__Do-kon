...
export const ProductDeatils = () => {
  ...
  const [selectedPrice, setSelectedPrice] = useState(
    price.find((prices) => prices.color === color[0].value)
  );
      ...
      <section className="container mt-16 slideproduct">
        ...
        >
          ...
          <div className="deatils lg:w-1/2 px-16 pt-16">
              ...
              <div className="flex items-center gap-3 mt-5">
                {color.map((colorOption, index) => (
                  <div
                    ...
                    className={`w-4 h-4 rounded-full -mt-3 cursor-pointer border-gray-300 shadow-sm shadow-[#383838] 
            ...
            <div className="flex items-center gap-3 mt-6">
              <button className="flex  gap-2 items-center secondary-btn">
                <BiHeart size={20} />
                Add to Wishlist
              </button>
              <button className="flex  gap-2 items-center secondary-btn">
        ...
        <div className="flex justify-between flex-col lg:flex-row my-10">
          <div className=" lg:w-1/2">
            ...
            <Caption>Designed for superior child comfort, OneFire provides extra rear-facing legroom and multiple recline options in every mode of use. With the widest range of height adjustments, the easy-adjust headrest system adjusts with the harness to grow with your child. OneFire accommodates tiny passengers from the very start with a removable head and body support insert for newborns weighing 5-11 lb.</Caption>
            <Title level={3} className="mt-5">Specifications</Title>
            <div className="flex flex-col gap-3 mt-2">
              <Caption>Assembled Dimensions (L x W x H): 21.5" x 1.0" x 2.7"</Caption>
              ...
              <Caption>Proposed Factors (Child Max Height) Capacified in</Caption>
            </div>
          </div>
          <div className=" lg:w-1/2 grid grid-cols-2 gap-5 lg:px-8 mt-5">
            ...
            <ProductDetailsBox
              ...
              desc="Chisco patented SuperClinch force-multiplying LATCH tightener ensures a tight and secure fit every time"
            />
