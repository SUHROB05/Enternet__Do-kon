                ...
                <div className="container h-full flex items-center justify-center">
                    <div className="w-1/2 flex relative z-50">
                        <div className="box w-96 h-96 bg-white rounded-full z-50 ">
                            <img
                                src="../images/hero/girl.png" alt=""
                                className=' absolute -top-[130px] left-0 z-10 rounded-b-full'
                            />
                        </div>
                        <div className="bg-[rgb(255, 255, 255, 0.5)] px-5 backdrop-blur-sm p-3 rounded-lg absolute top-36 right-60 z-50">
                            <BodyOne className="leading-none ">
                                Our Satisfied User
                            </BodyOne>
                    ...
                    <div className="left w-1/2 relative z-50">
                        ...
                        <BodyOne className="mb-8">
                            ...
                            the readabele content of a page when looking at its layout. The
                            point of using Lorem Ipsum is that it has a more-or-less normal
                            distribution of leatters,.
                        </BodyOne>
                        <Slider {...settings}>
                            <TestimonialsCard
                                name="Kenneth Fong"
