...
import { BodyOne, Title, Caption } from '../common/CustomComponents';
...
export const HeroItem = ({ title, description, prices, colors, image }) => {
    ...
    const [selectedPrice, setSelectedPrice] = useState(
        prices.find((prices) => prices.color === colors[0].value)
    );
    ...
    return (
        <div>
            <section
                className="content h-[50vh] lg:h-[90vh]  relative z-20 flex justify-between lg:px-16">
                <div className="left w-1/2 p-8 lg:p-32 lg:py-64">
                    ...
                    <div className='flex items-center justify-start gap-8 '>
                        ...
                        <div className='flex flex-col items-center justify-center  '>
                            ...
                            <div className="flex items-center justify-center gap-3 mt-5 my-2">
                                {colors.map((color, i) => (
                                    <div key={i}
                ...
                <div
                    className=" lg:bg-black lg:h-[96vh] lg:absolute lg:top-0 lg:right-0 lg:w-1/3 lg:-z-10">
